...
const SuggestPricingOutputSchema = z.object({
  estimatedPriceRange: z
    .string()
    .describe(
      'An estimated price range for the requested service, based on the provided requirements.'
    ),
});
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an AI pricing assistant for Apex Digital Group, a full-service digital agency.

You will receive a service type and a description of the client's requirements. Based on this information, you will provide an estimated price range for the service.

Service Type: {{{serviceType}}}
Requirements: {{{requirements}}}

Please provide a price range that is both realistic and attractive to potential clients.
`, config: {
    safetySettings: [
      {
